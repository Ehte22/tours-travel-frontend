import { faCalendar, faCalendarDays, faCalendarTimes, faCheck, faClock, faCrosshairs, faDollar, faEnvelope, faHeadphones, faHeadphonesSimple, faMinus, faPhone, faPlus, faStar, faStarHalfAlt, faUser, faUsers, faXmark } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { Box, Button, Card, CardContent, Container, Divider, Grid, IconButton, Paper, Popper, TextField, Typography } from '@mui/material'
                        ...
                        <Grid item xs={12} md={8}>
                            ...
                            <Box>
                                ...
                                {tour.itinerary && tour.itinerary.map((item, i) => <Box key={i} marginTop={'10px'}>
                                    <Typography
                                        onClick={e => handleDayClick(item.day)}
                                                    ...
                                                    <CardContent>
                                                        ...
                                                        <Box sx={{ fontSize: '18px', marginTop: '16px', marginLeft: '5px', display: 'flex', alignItems: 'center' }}>
                                                            ...
                                                            <Box sx={{ marginLeft: '14px' }}>
                                                                <Button onClick={e => setCount(count > 1 ? count - 1 : count)} variant='outlined' sx={{
                                                                ...
                                                                <Button onClick={e => setCount(count + 1)} variant='outlined' sx={{
                                                                    height: '30px', width: '20px', minWidth: '30px', borderColor: '#cd2c22',
                                                                    '&:hover': {
                                                                        borderColor: '#cd2c22'
                                                                    }
