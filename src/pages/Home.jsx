...
import { faArrowTrendUp, faCar, faCertificate, faGlobe, faHotel, faPercent, faPlane, faQuoteLeft, faStar, faStarHalfAlt, faTag, } from '@fortawesome/free-solid-svg-icons';
                        ...
                        <Box sx={{ marginTop: '40px', display: 'flex', justifyContent: 'center', gap: '10px' }}>
                            {
                                buttons && buttons.map(item => <Button
                                    key={item.name}
                                    onClick={e => handleClickButton(item.form)}
                                    sx={{
                        ...
                        {populatDestination.map((item, i) => <Grid key={i} item sm={item.sm} xs={item.xs} md={item.md} height={'100%'}>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Typography sx={{ marginTop: '10px', fontSize: '14px', textAlign: 'center', fontSize: '16px' }}>
                                        {item.desc}
                                    </Typography>
                                    <Link
