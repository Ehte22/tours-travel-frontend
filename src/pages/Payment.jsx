import { faCheck, faCrosshairs, faDollar, faEnvelope, faHeadphonesSimple, faLock, faPhone, faStar } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { Box, Button, Card, CardContent, Checkbox, Container, Divider, FormControl, FormControlLabel, Grid, InputLabel, MenuItem, Select, Step, StepLabel, Stepper, styled, TextField, Typography } from '@mui/material'
                                    ...
                                    <Grid item md={8}>
                                        <Stepper activeStep={currentStep} alternativeLabel connector={null}>
                                            <Grid container spacing={2}>
                                                {steps.map((item, i) => <Grid item xs={6} md={3}>
                                                    <Step key={i} completed={i < (currentStep - 1)} >
